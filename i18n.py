...
""",
        ...
        "total_tax": "总税收",
        "pre_tax_profit": "税前利润",
        "spending_limit": "💰 本轮总花费限制",
        "spending_limit_exceeded": "⚠️ 总花费超过上限！",
        "spending_limit_msg": "{} 本轮总花费 **{:,.0f}** 元，超过上限 **{:,.0f}** 元（账面现金 {:,.0f} + 初始资金 {:,.0f}）。请减少投入后重新提交。",
...
""",
        ...
        "spending_limit": "💰 Round Spending Limit",
        "spending_limit_exceeded": "⚠️ Spending Over Limit!",
        "spending_limit_msg": "{} total spending **{:,.0f}** exceeds limit **{:,.0f}** (Cash {:,.0f} + Initial {:,.0f}). Please reduce and resubmit.",
